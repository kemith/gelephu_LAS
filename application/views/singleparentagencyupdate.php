<
        ...
        <div id="page-wrapper">
            ...
            <div class="row">
                <!-- Page Header -->
                <div class="col-lg-12">
                    <h1 class="page-header">Parent Agency Head Update</h1> <div class="clockwrapper"><div id="clock"></div>, <?php echo date('D d/M/Y');?></div>
                </div>
                <!--End Page Header -->
            </div>
 ...
 <div class="panel panel-primary">
                        <div class="panel-heading">
                            <i class="fa fa-bar-chart-o fa-fw"></i>Update Parent Agency Head
                                ...
                                <div class="col-lg-12">
                                    <div class="table-responsive">
										...
										<th>Supervisor</th>
                                            ...
                                            <tbody >
                                            	<?php $counter=1;$pagency; foreach($pagency->result() as $row){?>
                                            <tr >
                                            	...
                                            	<td><select id="supervisor"><option selected="selected" value="0"><?php if($row->Supervisor==''){echo "Not Assigned";}else{echo $row->Supervisor;};?></option>
                                            		 <?php foreach($supervisors->result() as $s){
                                          			$pagency=$row->AgencyParentID;
														 if($s->name!=$row->Supervisor){
															if($row->Supervisor!=$s->name){ ?>
																<option value="<?php echo $pagency;?>,<?php echo $s->cid;?>"><?php echo $s->name;?></option>
